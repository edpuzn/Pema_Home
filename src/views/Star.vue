...
export default {
  ...
  data() {
    return {
      ...
      activeImageIndex: (Array(6).fill(0)), // Her ürün için aktif görsel indeksi
      ...
      products: [
        {
          title: 'Etna',
          description: 'Modern çizgiler ve yüksek konforu bir arada sunan Star koltuk takımı',
          images: [
            require('@/assets/pemahome_görseller/star/etna/star_model_etna_gardırop_1.jpg'),
            require('@/assets/pemahome_görseller/star/etna/star_model_etna_gardırop_2.jpg'),
            require('@/assets/pemahome_görseller/star/etna/star_model_etna_gardırop_3.jpg')
          ]
        },
        {
          title: 'Milenyum',
          ...
          images: [
            require('@/assets/pemahome_görseller/star/milenyum/star_model_milenyum_gardırop_1.jpg'),
            require('@/assets/pemahome_görseller/star/milenyum/star_model_milenyum_gardırop_2.jpg'),
            require('@/assets/pemahome_görseller/star/milenyum/star_model_milenyum_gardırop_3.jpg')
          ]
        },
        {
          title: 'Titanyum',
          ...
          images: [
            require('@/assets/pemahome_görseller/star/titanyum/star_model_titanyum_gardırop_1.jpg'),
            require('@/assets/pemahome_görseller/star/titanyum/star_model_titanyum_gardırop_2.jpg'),
            require('@/assets/pemahome_görseller/star/titanyum/star_model_titanyum_gardırop_3.jpg')
          ]
        },
        {
          title: 'Perla',
          description: 'Geniş depolama alanı sunan şık ve modern TV ünitesi',
          images: [
            require('@/assets/pemahome_görseller/star/perla/star_model_perla_gardırop_2.jpg'),
            require('@/assets/pemahome_görseller/star/perla/star_model_perla_gardırop_2.jpg'),
            require('@/assets/pemahome_görseller/star/perla/star_model_perla_gardırop_3.jpg')
          ]
        },
        {
          title: 'Eva',
          ...
          images: [
            require('@/assets/pemahome_görseller/star/eva/star_model_eva_gardırop_1.jpg'),
            require('@/assets/pemahome_görseller/star/eva/star_model_eva_gardırop_2.jpg'),
            require('@/assets/pemahome_görseller/star/eva/star_model_eva_gardırop_3.jpg')
          ]
        }
      ]
    }
